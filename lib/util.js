...
function namedFunction(){
    ...
    //functionName, argName, argHandlerName, body
    var body = arguments.pop();
    validateArg('namedFunction', 'body', body, 'function');
    //util.validateArg('namedFunction',
    // ['functionName', 'argName', 'argHandlerName'], arguments, 'string')
    ...
    var result = function(name, handler) {
        ...
        validateArg(functionName, argHandlerName, handler,
            'function');
...
[extend,
    ...
    namedFunction].forEach(function(member) {
